...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=df8ac10f9cbf80098f57e89fc7362c6e`);
  ...
  useEffect(()=>{
    document.title = `Details For/${movie.title} /Cinemate`
